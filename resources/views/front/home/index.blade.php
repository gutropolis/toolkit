                                        ...
                                        <div class="pricing-box">
                                            <div class="pricing-body b-l">
                                                <div class="pricing-header">
                                                    ...
                                                    <h2 class="text-center"><span class="price-sign">$</span>{{ $pkg->price_month }}</h2>
                                                ...
                                                <div class="price-table-content">
                                                    ...
                                                    <div class="price-row">
													    @if (Auth::check())
														  <a class="btn btn-success waves-effect waves-light m-t-20"   href="{{ URL::to('/price-package/') }}/{{ $pkg->slug }}">Change</a>
														@else
