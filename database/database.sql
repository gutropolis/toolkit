...
CREATE TABLE IF NOT EXISTS `saas_country` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `iso` char(2) NOT NULL,
...
INSERT INTO `saas_country` (`id`, `iso`, `name`, `nicename`, `iso3`, `numcode`, `phonecode`) VALUES
...
-- 
CREATE TABLE `saas_timezones` (
	`id` TINYINT(3) UNSIGNED NOT NULL AUTO_INCREMENT,
	`timezone_location` VARCHAR(30) NOT NULL DEFAULT '' COLLATE 'utf8mb4_unicode_ci',
	`gmt` VARCHAR(11) NOT NULL DEFAULT '' COLLATE 'utf8mb4_unicode_ci',
...
INSERT INTO `saas_timezones` VALUES (1, 'International Date Line West', '(GMT-12:00)', -12),
...
-- Dumping structure for table dsr.saas_locales
CREATE TABLE IF NOT EXISTS `saas_locales` (
...
-- Dumping data for table dsr.saas_locales: ~282 rows (approximately)
DELETE FROM `saas_locales`;
/*!40000 ALTER TABLE `saas_locales` DISABLE KEYS */;
INSERT INTO `saas_locales` (`locale`, `code`, `language`, `name`) VALUES
...
--/*!40000 ALTER TABLE `saas_locales` ENABLE KEYS */;
 
-- Dumping structure for table dsr.saas_languages
CREATE TABLE `saas_languages` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table dsr.saas_languages: ~17 rows (approximately)
DELETE FROM `saas_languages`;
/*!40000 ALTER TABLE `saas_languages` DISABLE KEYS */;
INSERT INTO `saas_languages` (`code`, `name`, `icon`, `active`) VALUES
	('cs', 'czech', 'cs', 1),
	('de', 'german', 'de', 1),
	('el', 'greek', 'gr', 1),
	('en', 'english', 'us', 1),
